...
test('test choice workflow first choice chosen', () => {
    ...
    horchata.executeWorkflow(workflowPaths.choice, testCase, 'us-east-1', (data) => {
        expect(data).toEqual(afterChoiceWorkflow);
        expect(data).toEqual({array: [4, 8, 14]});
    });
});

test('test choice workflow second choice chosen', () => {
...
test('test choice workflow default choice chosen', () => {
